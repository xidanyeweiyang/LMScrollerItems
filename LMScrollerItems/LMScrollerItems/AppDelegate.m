...
#import "LMScrollerItemsViewController.h"
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    LMScrollerItemsViewController *itemsController = [[LMScrollerItemsViewController alloc] init];
    ...
    LMNavigationViewController *navigationController = [[LMNavigationViewController alloc] initWithRootViewController:itemsController];
